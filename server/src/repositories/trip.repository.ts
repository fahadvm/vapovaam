...
const SEED_DATA: ITrip[] = [
    ...
    },
    {
        ...
        duration: '4 Days',
        price: 1299,
        image: 'https://images.unsplash.com/photo-1666489022516-a9041fce76db?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NTAxMTZ8MHwxfHNlYXJjaHw5fHx0cmF2ZWwlMjBkZXN0W5hdGlvbiUyMHZlcnRpY2FsfGVufDB8fHx8MTc2NTk0ODM5OXww&ixlib=rb-4.1.0&q=80&w=1080',
        images: [
...
export class TripRepository implements ITripRepository {
    ...
    private async seedData() {
        try {
            ...
            if (count === 0) {
                await TripModel.insertMany(SEED_DATA);
